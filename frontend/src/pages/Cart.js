...
const handlePayment = async()=>{
        ...
        // Sanitize productImage arrays to remove empty or invalid entries
        const sanitizedCartItems = data.map(item => {
            return {
                ...item,
                productId: {
                    ...item.productId,
                    productImage: Array.isArray(item.productId.productImage) ? item.productId.productImage.filter(img => typeof img === 'string' && img.trim() !== '') : []
                }
            }
        })
